...
public class App {
    public static void main(String[] args) {
        String filePath = "C:\\Users\\noah0\\Documents\\2025_Spring\\Projects\\Zoo\\src\\zooApp\\arrivingAnimals.txt";
    ...
    private static void processAnimals(String filePath, ArrayList<zooApp.Animal> animals, HashMap<String, Integer> speciesCount) {
        ...
        try (Scanner scanner = new Scanner(file)) {
            while (scanner.hasNextLine()) {
                ...
                if (species.equals("Hyena"))
                    animals.add(new zooApp.Hyena(name, age));
                if (species.equals("Lion"))
                    animals.add(new zooApp.Lion(name, age));
                if (species.equals("Tiger"))
                    animals.add(new zooApp.Tiger(name, age));
                if (species.equals("Bear"))
                    animals.add(new zooApp.Bear(name, age));
    ...
    private static void genReport(ArrayList<Animal> animals, HashMap<String, Integer> speciesCount) {
        String outputFile = "C:\\Users\\noah0\\Documents\\2025_Spring\\Projects\\Zoo\\src\\zooApp\\newAnimals.txt";
            ...
            for (String species : speciesCount.keySet()) {
                ...
                for (Animal animal : animals) {
                    if (animal.getSpecies().equals(species))
                        writer.write("Name: " + animal.getAge() + ", Age: " + animal.getAge() + "\n");
                }
                writer.write("\n");
            }
        } catch (IOException e) {
    ...
    private static String genAnimalName(String species) {
        String filePath = "C:\\Users\\noah0\\Documents\\2025_Spring\\Projects\\Zoo\\src\\zooApp\\animalNames.txt";
        File file = new File(filePath);
